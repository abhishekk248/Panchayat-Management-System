...
public class Caste{
		...
		public void start(String s1,Stage myStage,int y) throws ClassNotFoundException,SQLException{
			...
			myStage.setTitle("CASTE CERIFICATE");
			...
			Text title =new Text("Caste Certificate");
		    ...
		    t2=new TextField();
			t2.setPromptText("Enter Date of birth");
			...
			t5=new TextField();
			t5.setPromptText("Enter your caste");
			t5.setPrefColumnCount(15);
			
			t10=new TextField();
			t10.setPromptText("Enter your Income");
			t10.setPrefColumnCount(15);
			
			
			t9=new TextArea();
			t9.setPromptText("Enter adress");
			...
			btSubmit.setOnAction(e->{
					try {	
						String username;   //fetch username from database and update it
						SQLCaste h1= new SQLCaste(x,uname ,t1.getText(),t2.getText(),t3.getText(), t4.getText(), 
								t5.getText(), t6.getValue(), t7.getText(), t8.getText(),t9.getText(),t10.getText());
						CategoryAdmin sqd1=new CategoryAdmin(x,"Caste Certificate",0);
