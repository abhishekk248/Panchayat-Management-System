...
public class DisBirth{
	public void start(Stage myStage,int x,String s1,String s2,String s3,String s4,String s5,String s6,String s7,String s8,String s9,
		...
		Label l2=new Label("BIRTH CERTIFICATE");
		l2.setLayoutX(209.0);
		l2.setLayoutY(68.0);
		l2.setFont(f2);
		...
		Label ul10=new Label(s7);
		ul10.setLayoutX(414.0);
		ul10.setLayoutY(466.0);
		ul10.setPrefHeight(26.0);
		ul10.setPrefWidth(175.0);

		Label l16=new Label("Category:");
		l16.setLayoutX(42.0);
		l16.setLayoutY(517.0);
		Label ul11=new Label(s13);
		ul11.setLayoutX(132.0);
		ul11.setLayoutY(513.0);
		ul11.setPrefHeight(26.0);
		ul11.setPrefWidth(175.0);

		Label l17=new Label("Mother Name:");
		l17.setLayoutX(320.0);
		l17.setLayoutY(517.0);
		Label ul12=new Label(s8);
		ul12.setLayoutX(414.0);
		ul12.setLayoutY(513.0);
		ul12.setPrefHeight(26.0);
		ul12.setPrefWidth(175.0);

		Label l18=new Label("Address:");
		l18.setLayoutX(47.0);
		l18.setLayoutY(582.0);
		Label ul13=new Label(s9);
		ul13.setLayoutX(131.0);
		ul13.setLayoutY(570.0);
		...
		ap.getChildren().addAll(ul11,l17,ul12,l18,ul13,l19,ul14,l20,ul15,l21,ul16);
